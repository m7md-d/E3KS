...
//
// **الرقم الذي غيّر التصميم:** مستند بثمانمئة صفحة يبلغ ٩٢٦MB بالشجرة
// و١٤٢MB بالتدفّق الكامل — ستّة أضعاف ونصف. والمعاينة المحفوظة رخيصة
// (نحو ٥MB لمئة صفحة)؛ الغالي هو **بناؤها**، لا الاحتفاظ بها.
//
...
// المُترجَم ١١MB.
//
//   tree     كما يعمل التطبيق اليوم: الملف بايتاتٍ كاملة، ثم شجرة XML
...
Future<void> main(List<String> args) async {
  ...
  switch (mode) {
    // أ — كما يعمل التطبيق اليوم: الملف كلّه بايتات، ثم شجرة.
    case 'tree':
