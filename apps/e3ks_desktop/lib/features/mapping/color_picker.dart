...
/// ألوان مسمّاة من مصدر واحد: هوية محفوظة.
...
class _ColorDialog extends StatefulWidget {
  ...
  /// **الاختيار السريع.** ألوان مسمّاة من الهويات المحفوظة. الغرض ألّا
  /// يبني المستخدم كل لون في وقته: أغلب الحالات لصقُ لون هوية جاهز.
  ///
  /// **وهويات الملفات المفتوحة ليست منها.** كانت تُستخرَج في حينها وتُضاف،
  /// فملأت النافذة على مجلدٍ حتى تعذّر اعتماد لون. ومن أراد ستايل ملفٍّ
  /// حفظه هوية.
